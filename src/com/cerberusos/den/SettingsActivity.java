...
import com.cerberusos.den.dslv.ActionListViewSettings;
import com.cerberusos.den.fragments.Dashboard;
import com.cerberusos.den.preference.MasterSwitchPreference;
import com.cerberusos.den.preference.MasterSwitchPreferenceDependencyHandler;
import com.cerberusos.den.preference.SecureSettingMasterSwitchPreference;
import com.cerberusos.den.preference.SecureSettingSwitchBarController;
import com.cerberusos.den.preference.SystemSettingMasterSwitchPreference;
import com.cerberusos.den.preference.SystemSettingSwitchBarController;
import com.cerberusos.den.utils.Util;
import com.cerberusos.den.widget.SwitchBar;
...
public class SettingsActivity extends BaseActivity {
    ...
    private static final String EXTRA_SWITCH_SYSTEM_SETTINGS_KEY =
            "com.cerberusos.den.extra.preference_switch_system_settings_key";
    ...
    private static final String EXTRA_SWITCH_SYSTEM_SETTINGS_DEFAULT_VALUE =
            "com.cerberusos.den.extra.preference_switch_system_settings_default_value";
    ...
    private static final String EXTRA_SWITCH_SECURE_SETTINGS_KEY =
            "com.cerberusos.den.extra.preference_switch_secure_settings_key";
    // Default value for switch bar controlling the system setting
    private static final String EXTRA_SWITCH_SECURE_SETTINGS_DEFAULT_VALUE =
            "com.cerberusos.den.extra.preference_switch_secure_settings_default_value";
    // Mutual exclusive dependencies for master switches
    private static final String EXTRA_SWITCH_SYSTEM_SETTINGS_MUTUAL_KEYS =
            "com.cerberusos.den.extra.preference_switch_system_settings_mutual_keys";
    private static final String EXTRA_SWITCH_SECURE_SETTINGS_MUTUAL_KEYS =
            "com.cerberusos.den.extra.preference_switch_secure_settings_mutual_keys";
    private static final String EXTRA_SWITCH_THERE_SHOULD_BE_ONE =
            "com.cerberusos.den.extra.preference_switch_there_should_be_one";
