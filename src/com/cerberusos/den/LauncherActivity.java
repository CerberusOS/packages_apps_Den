...
public class LauncherActivity extends SettingsActivity {
    ...
    private void initShortcutManager() {
        ...
        if (Util.isPackageEnabled(Constants.CERBERUSOS_OTA_PACKAGE, this.getPackageManager())) {
            // Intent for launching CERBERUSOS OTA
            ...
            ShortcutInfo baikalosotaShortcut = new ShortcutInfo.Builder(this, "baikalosota")
                    .setShortLabel(getString(R.string.cerberusos_ota_title))
                    .setLongLabel(getString(R.string.cerberusos_ota_title))
            ...
            ShortcutInfo downloadsShortcut = new ShortcutInfo.Builder(this, "downloads")
                    .setShortLabel(getString(R.string.cerberusos_downloads_title))
                    .setLongLabel(getString(R.string.cerberusos_downloads_title))
                    .setIcon(Icon.createWithResource(this,
