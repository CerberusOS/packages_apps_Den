...
import com.cerberusos.gear.preference.SeekBarPreferenceCham;
...
public class AppProfile extends BaseSettingsFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCerberusService = ICerberusServiceController.Stub.asInterface(
            ...
            Log.e(TAG, "onCreate: Fatal! mCerberusService=null", e );
            return;
        }
        if( mCerberusService == null ) {
            Log.e(TAG, "onCreate: Fatal! mCerberusService=null" );
            return;
        }
        ...
        if( mAppRestricted != null ) { 
            ...
            mAppRestricted.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
              public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                try {
                    mCerberusService.setAppPriority(mPackageName, ((Boolean)newValue) ? -1 : 0 );
        ...
        if( mAppCameraHal1 != null ) { 
            ...
            mAppCameraHal1.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
              public boolean onPreferenceChange(Preference preference, Object newValue) {
                try {
                    mCerberusService.setAppOption(mPackageName, CerberusServiceManager.OP_CAMERA_HAL1, ((Boolean)newValue) ? 1 : 0 );
        ...
        if( mAppPerfProfile != null ) { 
            if(!perfProf) {
                ...
                String profile = mCerberusService.getAppPerfProfile(mPackageName);
                ...
                mAppPerfProfile.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                  public boolean onPreferenceChange(Preference preference, Object newValue) {
                    try {
                        mCerberusService.setAppPerfProfile(mPackageName, newValue.toString() );
        ...
        if( mAppThermProfile != null ) {
            if(!thermProf) {
                ...
                String profile = mCerberusService.getAppThermProfile(mPackageName);
                ...
                mAppThermProfile.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                  public boolean onPreferenceChange(Preference preference, Object newValue) {
                    try {
                        mCerberusService.setAppThermProfile(mPackageName, newValue.toString() );
            ...
            if( mAppBrightnessProfile != null ) {
                int brightness = mCerberusService.getAppBrightness(mPackageName);
                ...
                mAppBrightnessProfile.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                  public boolean onPreferenceChange(Preference preference, Object newValue) {
                    try {
                        int val = Integer.parseInt(newValue.toString());
                        mCerberusService.setAppBrightness(mPackageName, val );
