...
public class AudioTweaks extends BaseSettingsFragment
    ...
    private boolean mCerberus8996AudioHal;
    private boolean mCerberusLeecoDevice;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCerberus8996AudioHal = res.getBoolean(
                com.android.internal.R.bool.config_useCerberus8996AudioHal);

        mCerberusLeecoDevice = res.getBoolean(
                com.android.internal.R.bool.config_useCerberusLeecoDevice);

        mEnableANC = (SwitchPreference) findPreference(AUDIO_TWEAKS_ANC);
        if( mEnableANC != null ) { 
                if( !mCerberus8996AudioHal ) {
