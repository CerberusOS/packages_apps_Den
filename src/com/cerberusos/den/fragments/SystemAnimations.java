...
import com.cerberusos.den.utils.FinishingAnimationDrawable;
import com.cerberusos.den.utils.SuShell;
import com.cerberusos.den.utils.SuTask;
...
public class SystemAnimations extends BaseSettingsFragment {
    ...
    private static final String BACKUP_PATH = new File(Environment
            .getExternalStorageDirectory(), "/cerberusos_backup").getAbsolutePath();
