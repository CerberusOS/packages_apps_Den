...
public class Utilities {
	...
	public static String getDevice() {
		return SystemProperties.get("ro.cerberusos.device");
	}
	...
	public static String getModVersion() {
        ...
        public static String getBuildType() {
                 return SystemProperties.get("ro.romstats.buildtype");
        }
	...
	public static void checkIconVisibility(Context context) {
        // Nothing to do here: we don't even show an icon for this
		...
		ComponentName componentToDisable =
                new ComponentName(context.getApplicationContext().getPackageName(),
                        AnonymousStats.class.getCanonicalName());
		if (cookieFile.exists()) {
			// exist, hide icon
