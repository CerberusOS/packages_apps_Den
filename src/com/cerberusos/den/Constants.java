...
public abstract class Constants {
    /**
     * Package name of CerberusOS OTA
     */
    public static final String CERBERUSOS_OTA_PACKAGE = "eu.chainfire.opendelta";

    /**
     * Default activity of CerberusOS OTA
     */
    public static final String CERBERUSOS_OTA_ACTIVITY = CERBERUSOS_OTA_PACKAGE + ".MainActivity";
